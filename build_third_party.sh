...
declare -A TARGET_ALIAS=(
    ["ascend_protobuf"]="ascend_protobuf_build"
    ["ascend_protobuf_static"]="ascend_protobuf_static_build"
    ["abseil"]="abseil_build"
    ["cares"]="cares_build"
    ["grpc"]="grpc_build"
    ["gtest"]="gtest_build"
    ["gtest_shared"]="gtest_shared_build"
    ["json"]="json_build"
    ["openssl"]="openssl_build"
    ["protobuf_static"]="protobuf_static_build"
    ["protoc"]="protoc_build"
    ["protoc_grpc"]="protoc_grpc_build"
    ["re2"]="re2_build"
    ["zlib"]="zlib_build"
    ["zlib_bin"]="zlib_bin_build"
    ["benchmark"]="benchmark_build"
    ["pybind11"]="pybind11_build"
    ["jpeg"]="jpeg_build"
    ["boost"]="boost_build"
    ["symengine"]="symengine_build"
)
# print usage message
usage() {
  echo "Usage:"
