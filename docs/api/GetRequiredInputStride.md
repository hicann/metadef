# GetRequiredInputStride<a name="ZH-CN_TOPIC_0000002519046125"></a>
...
指定的输入Tensor的Stride指针。关于Stride类型的定义，请参见[Stride](Stride.md)。

当输入ir\_index非法或Tensor不携带非连续描述信息时，返回空指针。
