# GetOptionalInputStride<a name="ZH-CN_TOPIC_0000002487046234"></a>
...
指定ir\_index的输入Tensor的Stride指针。关于Stride类型的定义，请参见[Stride](Stride.md)。

当输入ir\_index非法或该INPUT没有实例化或该Tensor未携带非连续描述信息时时，返回空指针。
