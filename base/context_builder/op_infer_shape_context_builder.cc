...
static_assert(sizeof(OpInferShapeContextBuilderImpl) == sizeof(ContextBuilderImpl),
              "OpInferShapeContextBuilderImpl size error");

OpInferShapeContextBuilder::OpInferShapeContextBuilder() : OpContextBuilderBase<OpInferShapeContextBuilder>() {
