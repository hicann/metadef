...
if(pybind11_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    message(STATUS "[ThirdPartyLib][pybind11] pybind11 found in ${PYBIND11_INSTALL_PATH}, and not force rebuild cann third_party")
    ...
    message(STATUS "[ThirdPartyLib][pybind11] pybind11 not found in ${PYBIND11_INSTALL_PATH}, begin load from ${REQ_URL}")
    ...
    if(NOT TAR_RESULT EQUAL 0)
        message(FATAL_ERROR "[ThirdPartyLib][pybind11] Failed to tar xf ${PYBIND11_DOWNLOAD_PATH}/pybind11-2.13.6.tar.gz")
    endif()
