...
# 执行安装到临时目录
execute_process(
    COMMAND "${CMAKE_COMMAND}" --install "${CPACK_CMAKE_BINARY_DIR}" --prefix "${STAGING_DIR}" --component metadef
...
configure_file(
    ${OPS_VERSION_OUT_PUT}
    ${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/metadef_version.h
    COPYONLY
)
configure_file(
    ${CSV_OUTPUT}
